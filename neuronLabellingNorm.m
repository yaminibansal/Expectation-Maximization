function[neuronHist, digitHist, neuronLabel]=neuronLabellingNorm(trainLabels, y, yLabels)
...
for k=1:Kout
    ...
    trainLabelSize(k, 1)=length(find(trainLabels==(yLabels(k))));
end

digitHist=neuronHist';
neuronHistNorm=neuronHist./(trainLabelSize*ones(1, 10));


[neuronVal, neuronLabel]=max(neuronHistNorm);
