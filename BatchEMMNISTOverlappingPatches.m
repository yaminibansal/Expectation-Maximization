...
noRowsPatch=5;                          % No. of rows in input patch
noColsPatch=5;                          % No. of cols in input patch
noPixels=noRows*noCols;
noPatches=(noRows-noRowsPatch+1)*(noCols-noColsPatch+1);
...
noDataPoints=length(indices); %size(trainImages,2);%
count=0;
